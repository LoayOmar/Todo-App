    ...
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        child: Container(
          ...
          child: AppCubit.get(context).userModel == null ? const Center(child: CircularProgressIndicator()) : Column(
            children: [
              Padding(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              if(AppCubit.get(context).newTasks[index]['uId'] == uId) {
                                return buildTaskItem(AppCubit.get(context).newTasks[index], context);
                              }
